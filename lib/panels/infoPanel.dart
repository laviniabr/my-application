    ...
    return Container(
      child: Column(
        children: <Widget>[
          ...
          GestureDetector(
            onTap: (){
              launch('https://www.who.int/emergencies/diseases/novel-coronavirus-2019/advice-for-public/myth-busters?gclid=Cj0KCQjwvr6EBhDOARIsAPpqUPGCCT7hE-tfapPPqRpah3D9EvGFSFQPxItfEmZTAHtc6ZVYmHYtdh8aAr9kEALw_wcB');
            },
            child: Container(
              padding: EdgeInsets.symmetric(vertical: 12,horizontal: 10),
              margin: EdgeInsets.symmetric(vertical: 5,horizontal: 10),
